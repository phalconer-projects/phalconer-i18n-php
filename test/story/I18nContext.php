...
use phalconer\i18n\provider\TranslatorServiceProvider;
    ...
    public function __construct()
    {
        $config = [
            'services' => [
                ...
                'translator' => [
                    'provider' => TranslatorServiceProvider::class,
...
//                    'defaultSourceName' => 'app',
        ...
        $this->translator = $this->app->getDI()->get('translator');
    ...
    public function theAsTranslationAdapter($source)
    {
        ...
        $this->app->getDI()->setShared('translator', $this->translator);
        $this->translator->registerRedirectDispatcherEvent();
    }
